...
import BinByCategories.BinByCategories;
import BinByCategories.BinByCategories.YouTubeBinMapper;

public class BinByCategories {
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(BinByCategories.class);
