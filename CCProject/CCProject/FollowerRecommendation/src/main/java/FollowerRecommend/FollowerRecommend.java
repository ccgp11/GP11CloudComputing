...
import FollowerRecommend.Map;
import FollowerRecommend.FollowerRecommend;
import FollowerRecommend.Reduce;
import FollowerRecommend.Reduce.ValueComparator;

public class FollowerRecommend extends Configured implements Tool{
	@SuppressWarnings("deprecation")
    public int run(String[] args) throws Exception {
        System.out.println(Arrays.toString(args));
        Job job = new Job(getConf(), "NewFollowers");
        job.setJarByClass(FollowerRecommend.class);
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(Arrays.toString(args));
        int res = ToolRunner.run(new Configuration(), new FollowerRecommend(), args);
